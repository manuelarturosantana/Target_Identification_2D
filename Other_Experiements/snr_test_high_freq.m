...
fw = 5;
gap = 2;
scat_name = "circularcavity";
scat_name = "ellipticcavity";
load("/scratch/msantana/time_domain_data_2D/" + scat_name + num2str(gap) + ".mat")
%%
inds_r = [1,5,10,15,20,25,30,35,40,50];
for rec_ind = inds_r
