...
rng(1);
fprintf("==============================================\n");
fprintf(" Plane Convergence test (poles in user range)\n");
fprintf("==============================================\n\n");
...
% refinement levels
% --------------------------------------------------
NREF = 1;   % comparisons; finest is reference
...
% geom = quadjet_plane_geometry(gparams);
...
% --------------------------------------------------
save('poles_convergence_twinjet.mat', 'poles', 'all_svd_vals', 'wlims', 'wimag', 'numw', 'params');
