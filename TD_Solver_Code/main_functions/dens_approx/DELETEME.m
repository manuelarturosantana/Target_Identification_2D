%%
%% THE VERSION WHERE MMAX CHANGES BASED ON THE SIZE OF THE INPUT, DOESN"T WORK FOR LOW NUMBER OF FREQUES.
%%

function [r, pol, res, zer, z, f, w, errvec, mmax] = aaa_sv(F, varargin)
